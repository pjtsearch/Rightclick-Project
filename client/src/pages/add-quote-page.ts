...
import { createQuote } from "../services/api.ts"
import type { Customer, QuoteWithDetails } from "../types/databaseTypes.ts"
import "../components/add-quote-customer-stage.ts"
import "../components/add-quote-equipment-stage.ts"
import "../components/add-quote-labor-stage.ts"
import "../components/add-quote-finalize-stage.ts"
import "../components/voice-quote-assistant.ts"
import { navigate } from "../services/navigation.ts"
import { generateNewCustomer, generateNewQuote } from "../utils/quote/quote-draft.ts"
import { VoiceAssistantAction } from "../voice-assistant/voice-assistant.ts"
